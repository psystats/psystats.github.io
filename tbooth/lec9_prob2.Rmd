...
## Rules of probability
=======
>>>>>>> 1470af8c1f4ca8c3782bfc4fcf1db48635a18f62
...
## Conditional probability
- Sometimes we have events where the probability of one event may be dependent on whether another event has occured. 
- This is referred to as **conditional probability**.
- Probability of B **given** A, which is written, $p(B|A)$
>>>>>>> 1470af8c1f4ca8c3782bfc4fcf1db48635a18f62
...
=======
$$p(Left|Girl) = \frac{0.10}{0.35} = 0.286$$
>>>>>>> 1470af8c1f4ca8c3782bfc4fcf1db48635a18f62
...
=======
- What we have just done (more or less) is do all the backgroun work to understand a $\chi^2$ test of independence.
>>>>>>> 1470af8c1f4ca8c3782bfc4fcf1db48635a18f62
