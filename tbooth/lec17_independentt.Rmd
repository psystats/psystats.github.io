---
title: "Lecture 17: Independent t-test"
...
- So our critical value is -1.72
	- Our t-statistic is larger than this, -5.51.
...
- Levene's test:
	- Statistical test for the equality (or homogeneity) of variances across groups.
...
- In class we have been using examples with very small N.
	- This is purely so we can show working on slides etc.
- Typically, even with simple tests like we have discussed so far, with n ~20, you should think carefully about whether statistical analyses are appropriate.

## Tasks for this week...
1. Finish tasks from last week. 
2. Quiz 17: One-sample $t$-tests
    - Today at 17:00.
